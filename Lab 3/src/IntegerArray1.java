...
public class IntegerArray1 {
	...
	public static void main(String[] args) {
		 ...
		 * 2. The size of array is last index value + 1.
		 ...
		 * you can't reassign an array using the initializer.
		 * */
		 ...
		 * (This is the version that illustrates a common mistake that causes ArrayOutOfBoundException)
		 * */
//		for (int i = 0; i <= ia.length; i ++) {
//			/*
//			 * When i's value is incremented to ia.length (10), 10 <= 10 gives true,
//			 * meaning that we still execute the body of the loop using ia[10]
//			 * */
//			System.out.println("Element of ia at index " + i + ": " + ia[i]);
//		}
